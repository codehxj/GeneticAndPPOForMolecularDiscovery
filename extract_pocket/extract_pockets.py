import sys
import argparse
from data import PDBProtein, parse_drug3d_mol
...
if __name__ == "__main__":
    ...
    parser.add_argument("--protein", type=str, default="7s7l.pdb")
    parser.add_argument("--ligand", type=str, default="10182418.sdf")
    parser.add_argument("--radius", type=int, default=10)
    parser.add_argument("--pocket", type=str, default="7s7l_pocket.pdb")
